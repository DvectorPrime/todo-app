    ...
    return(
      <div className="grid grid-cols-[20px_1fr] gap-4 place-content-start px-4 py-5 border-b-1 border-b-black/15">
        ...
        <label htmlFor={todo.id}>
          <span className={`flex justify-between items-center w-full font-medium text-[17px] text-[121212] mb-2 text-[${todo.completed && "#666666"}]`}>{todo.task} <button onClick={deleteTask}><img src={deleteIcon} className="w-8"/></button></span>
